      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Certified Front-End developer <br className='sm:hidden' /> from <span className='text-[#915eff]'>META</span><br className='sm:block hidden' /> I Develop 3D visuals, user interfaces and web applications
          </p>
        </div>
      </div>
      <ComputersCanvas />
